...
ref_directory <- "vignettes/gsp_vignette_files/data/ref_dir"
```
...
dt <- readRDS("vignettes/gsp_vignette_files/data/dt_post_refclean.RDS")
```
...
```{r, echo = F}
dt <- readRDS('vignettes/gsp_vignette_files/data/dt_withagencies.rds')
```
...
dt <- readRDS("vignettes/gsp_vignette_files/data/dt_post_keras.RDS")
```
...
indexdf <- readRDS("vignettes/gsp_vignette_files/data/indexdf.rds")
```
